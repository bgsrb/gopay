...
//https://github.com/golang/go/blob/master/src/net/net.go#L540
//https://github.com/golang/go/blob/master/src/net/net.go#L548

type Error interface {
	ErrCode() string
}

type MellatError struct {
	code string
}

func (e MellatError) ErrCode() string {
	return e.code
}
func (e MellatError) Error() string {
	return ERRORS[string(e.code)]
}
